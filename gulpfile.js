...
gulp.task('install-deps',function(cb){
	...
	exec('cd archive/express-temp && npm install --production',function(err,stdout,stderr){
		if(err) throw err;
...
gulp.task('package',function(){
	return gulp.src('archive/express-temp*/**')
		.pipe($.tar('express-temp.tar'))
		.pipe($.gzip())
